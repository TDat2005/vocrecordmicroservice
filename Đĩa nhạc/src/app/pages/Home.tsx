        ...
        <div className="container mx-auto px-4 py-8 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-2 border-black bg-yellow-400 p-8 flex flex-col justify-center min-h-[400px] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('http://localhost/clonevocrecord/images/Photo-New-disc.png')] bg-cover bg-center mix-blend-multiply opacity-60 group-hover:opacity-80 transition-opacity"></div>
            ...
            <div className="border-2 border-black bg-red-600 text-white p-8 flex flex-col justify-center min-h-[400px] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all relative overflow-hidden group">
                <div className="absolute inset-0 bg-[url('http://localhost/clonevocrecord/images/Photo-Vintage-disc.png')] bg-cover bg-center mix-blend-multiply opacity-50 group-hover:opacity-70 transition-opacity"></div>
                <div className="relative z-10">
