...
export function Accessories() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-emerald-500 text-black border-b-2 border-black py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl lg:text-2xl font-bold max-w-2xl uppercase">
            Bảo vệ và chăm sóc bộ sưu tập âm thanh của bạn khỏi bụi thời gian.
          </p>
        </div>
      </div>
          ...
          <main className="flex-1">
            ...
            {filteredRecords.length === 0 ? (
              <div className="text-center py-16 border-2 border-black bg-white">
                <p className="text-black font-bold uppercase">Chưa có sản phẩm Phụ kiện nào.</p>
              </div>
            ) : (
