...
export function Cassettes() {
  ...
  return (
    <div className="page page-gray">
      <div className="category-hero" style={{background:'#8b5cf6',color:'#fff'}}>
        <div className="container"><h1>CASSETTE</h1><p>Sưu tầm những cuộn băng cassette huyền thoại lưu giữ âm thanh năm tháng.</p></div>
      </div>
      <div className="container" style={{padding:'2rem 1rem'}}>
        <div className="shop-layout">
          ...
          <main className="shop-main">
            ...
            {filteredRecords.length === 0 ? (<div className="empty-state"><p>Chưa có sản phẩm Cassette nào.</p></div>) : (
